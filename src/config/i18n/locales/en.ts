...
export default {
  ...
  agentic: {
    ...
    thinkingSkillRouting: 'Skill routing',
    thinkingSkillDetail: 'Selected {skill} for this request.',
    ...
    failedSkills: 'Failed to load agentic skills.',
