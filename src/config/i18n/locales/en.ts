  ...
  settings: {
    ...
    event: {
      ...
      overview: {
        ...
        bannerUnhandled: '{n} unconfirmed alarms need attention',
        bannerCta: 'Open unconfirmed list →',
        quickActions: 'Quick actions',
        quickUnconfirmed: 'Unconfirmed',
        quickDevice: 'Devices only',
        quickDriver: 'Drivers only',
        quickLastHour: 'Last 24h',
        types: {
