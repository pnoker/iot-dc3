...
export default {
  ...
  nav: {
    ...
    settingsAlarmHistory: 'Alarm Histories',
    settingsModel: 'Model',
    settingsAgentic: 'Model Config',
    settingsAgenticProvider: 'Model Providers',
    settingsEvent: 'Event',
    settingsEventOverview: 'Overview',
    settingsDeviceEvent: 'Device Alarm',
    settingsDriverEvent: 'Driver Alarm',
    settingsPointEvent: 'Point Alarm',
    settingsCommand: 'Command',
    settingsCommandRecord: 'Command Record',
    settingsEventReport: 'Event Report',
    settingsAbout: 'About',
