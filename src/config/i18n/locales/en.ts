...
export default {
  ...
  nav: {
    ...
    settingsAlarm: 'Alarm Notify',
    settingsAlarmRule: 'Alarm Rules',
    settingsAlarmNotify: 'Notify Policies',
    settingsAlarmMessage: 'Message Templates',
    settingsAlarmChannel: 'Notify Channels',
    settingsAlarmBind: 'Channel Bindings',
    settingsAlarmState: 'Runtime States',
    settingsAlarmRecord: 'Delivery Records',
    settingsModel: 'Model Management',
