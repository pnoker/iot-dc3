...
export const deleteLabel = (id: string) => httpPost(`${API_MANAGER_BASE}/label/delete/${id}`);

export const updateLabel = (label: LabelForm) => httpPost(`${API_MANAGER_BASE}/label/update`, label);

export const getLabelById = (id: string) => httpGet<R<LabelRecord>>(`${API_MANAGER_BASE}/label/id/${id}`);
