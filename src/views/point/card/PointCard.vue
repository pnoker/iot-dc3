			...
			<div class="things-card-content">
				...
				<div v-if="!embedded" class="things-card__footer">
					<div class="things-card-footer-operation">
						<el-popconfirm title="是否确定停用该位号？" placement="top" :icon="SwitchButton" icon-color="#e6a23c">
							<template #reference>
								<el-button type="primary" :disabled="!data.enable" link>停用</el-button>
							</template>
						</el-popconfirm>
						<el-popconfirm title="是否确定启用该位号？" placement="top" :icon="CircleCheck" icon-color="#67c23a">
							<template #reference>
