				...
				<el-form ref="formDataRef" :inline="true" :model="reactiveData.pointFormData" :rules="pointFormRule">
					<div class="edit-form-item">
						<el-form-item label="位号名称" prop="name">
							<el-input v-model="reactiveData.pointFormData.name" class="edit-form-large" placeholder="请输入位号名称" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
					</div>
					<div class="edit-form-item">
					...
					<div class="edit-form-item">
						<el-form-item label="数据格式" prop="format">
							<el-input v-model="reactiveData.pointFormData.format" class="edit-form-default" placeholder="请输入数据格式" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
						<el-form-item label="单位" prop="unit">
							<el-input v-model="reactiveData.pointFormData.unit" class="edit-form-default" placeholder="请输入单位" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
					</div>
					<div class="edit-form-item">
						<el-form-item label="基值" prop="base">
							<el-input v-model="reactiveData.pointFormData.base" class="edit-form-default" placeholder="请输入基值" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
						<el-form-item label="倍数" prop="multiple">
							<el-input v-model="reactiveData.pointFormData.multiple" class="edit-form-default" placeholder="请输入倍数" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
					</div>
					<div class="edit-form-item">
						<el-form-item label="最小值" prop="minimum">
							<el-input v-model="reactiveData.pointFormData.minimum" class="edit-form-default" placeholder="请输入最小值" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
						<el-form-item label="最大值" prop="maximum">
							<el-input v-model="reactiveData.pointFormData.maximum" class="edit-form-default" placeholder="请输入最大值" clearable @keyup.enter="pointUpdate"></el-input>
						</el-form-item>
					</div>
					<div class="edit-form-item">
