...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const rules: FormRules = {
      menuName: authNameRules(t, t('common.entityMenu')),
      menuCode: [
        { required: true, whitespace: true, message: t('settings.menu.menuCodePlaceholder'), trigger: 'blur' },
      ],
      titleZh: [{ required: true, whitespace: true, message: t('settings.menu.titleZhPlaceholder'), trigger: 'blur' }],
      titleEn: [{ required: true, whitespace: true, message: t('settings.menu.titleEnPlaceholder'), trigger: 'blur' }],
