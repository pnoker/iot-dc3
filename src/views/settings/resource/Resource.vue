  ...
  <div class="settings-page">
    <div class="settings-toolbar">
      <el-form :inline="true" class="settings-search">
        <el-form-item>
          <el-input
            v-model="reactiveData.query.resourceName"
            clearable
            :placeholder="t('settings.resource.resourceName')"
            @keyup.enter="search"
          />
        </el-form-item>
        <el-form-item>
          <el-input
            v-model="reactiveData.query.resourceCode"
            clearable
            :placeholder="t('settings.resource.resourceCode')"
            @keyup.enter="search"
          />
        </el-form-item>
        <el-form-item>
