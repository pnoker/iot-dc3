			...
			<el-form ref="formDataRef" class="tool-card-body" :model="reactiveData.formData" :rules="formRule" :inline="true">
				<div class="tool-card-body-form">
					<el-form-item prop="name" label="设备名称">
						<el-input v-model="reactiveData.formData.name" class="edit-form-default" placeholder="请输入设备名称" clearable @keyup.enter="search"> </el-input>
					</el-form-item>
					<el-form-item prop="driverId" label="所属驱动">
						<el-select v-model="reactiveData.formData.driverId" placeholder="请选择所属驱动" filterable clearable>
