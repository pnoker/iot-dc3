        ...
        <el-card shadow="hover">
            <div class="thing-card-content">
                ...
                <div class="thing-card__body">
                    ...
                    <div title="驱动描述信息" class="thing-card-body__content">
                ...
                <div class="thing-card__footer">
                    <div class="thing-card-footer-copy-id">
                        <el-tooltip effect="dark" placement="top" v-if="data.id" content="点击复制ID">
                            <el-button type="text" icon="el-icon-document-copy" v-on:click="copyId(data.id)">{{data.id}}</el-button>
                        </el-tooltip>
                    </div>
