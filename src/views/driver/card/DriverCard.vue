			...
			<div class="things-card-content">
				...
				<div v-if="!footer" class="things-card__footer">
					<div class="things-card-footer-operation">
						<el-popconfirm title="是否确定停用该驱动？" placement="top" :icon="SwitchButton" icon-color="#e6a23c">
							<template #reference>
								<el-button type="primary" link disabled>停用</el-button>
							</template>
						</el-popconfirm>
						<el-popconfirm title="是否确定启用该驱动？" placement="top" :icon="CircleCheck" icon-color="#67c23a">
							<template #reference>
								<el-button type="primary" link disabled>启用</el-button>
							</template>
						</el-popconfirm>
						<el-popconfirm title="是否确定删除该驱动？" placement="top" :icon="CircleClose" icon-color="#f56c6c">
							<template #reference>
								<el-button type="primary" link disabled>删除</el-button>
							</template>
						</el-popconfirm>
