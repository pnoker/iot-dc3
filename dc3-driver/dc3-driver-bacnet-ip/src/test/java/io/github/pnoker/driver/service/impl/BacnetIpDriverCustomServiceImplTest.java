...
class BacnetIpDriverCustomServiceImplTest {
    ...
    private BacnetIpDriverCustomServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new BacnetIpDriverCustomServiceImpl(driverMetadata, driverSenderService);
        // Skip initial(): not needed; validate/validatePoint/schedule touch no I/O.
    }
