...
public class OPCGroupStateMgt extends BaseCOMObject {
    ...
    public OPCGroupStateMgt(final IJIComObject opcGroup)
    ...
    /**
     * Set the group state Leaving any of the parameters <code>null</code> will keep the
     ...
     */
    public OPCGroupStateMgt clone(final String name)
