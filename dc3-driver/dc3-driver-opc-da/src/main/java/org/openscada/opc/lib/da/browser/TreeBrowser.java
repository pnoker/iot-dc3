 ...
 * <p>
 * The operations on the address space browser browser are not synchronized as is the
 * TreeBrowser itself. The user must take care of preventing simultanious access to this
...
public class TreeBrowser extends BaseBrowser {
     ...
     * @param accessMask     The access mask (use <code>EnumSet.noneOf ( Access.class )</code>
     *                       for all)
    ...
    /**
     * Fill the leaves and branches of the branch provided branches including alls
     * sub-branches.
     *
     * @param branch The branch to fill.
     * @throws IllegalArgumentException IllegalArgumentException
     ...
     * @throws JIException              JIException
     */
    protected void browseLeaves(final Branch branch)
    ...
    protected void browseBranches(final Branch branch, final boolean leaves, final boolean descend)
            throws IllegalArgumentException, UnknownHostException, JIException {
    ...
    protected void browse(final Branch branch, final boolean leaves, final boolean branches, final boolean descend)
            throws IllegalArgumentException, UnknownHostException, JIException {
        // process leaves
        if (leaves) {
            browseLeaves(branch);
