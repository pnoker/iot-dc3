...
public class OPCItemMgt extends BaseCOMObject {
    ...
    public KeyedResultSet<OPCITEMDEF, OPCITEMRESULT> add(final OPCITEMDEF... items) throws JIException {
        ...
        /*
         * callObject.addOutParamAsObject ( new JIPointer ( new JIArray (
         * OPCITEMRESULT.getStruct (), null, 1, true ) ), JIFlags.FLAG_NULL );
    ...
    public ResultSet<Integer> setClientHandles(final Integer[] serverHandles, final Integer[] clientHandles)
            throws JIException {
