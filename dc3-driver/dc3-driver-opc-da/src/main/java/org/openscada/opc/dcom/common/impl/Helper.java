...
public class Helper {
     ...
     */
    public static Object[] callRespectSFALSE(final IJIComObject object, final JICallBuilder callObject)
            throws JIException {
        try {
    ...
    /**
     * Perform some fixes on the variant when writing it to OPC items. This method only
     * changes control information on the variant and not the value itself!
     *
