...
public class BaseBrowser {
    ...
    /**
     * The batch size is the number of entries that will be requested with one call from
     * the server. Sometimes too big batch sizes will cause an exception. And smaller
     * batch sizes degrade perfomance. The default is set by
     * {@link EnumString#DEFAULT_BATCH_SIZE} and can be overridden by the java property
     ...
     * @throws IllegalArgumentException IllegalArgumentException
     */
    public Collection<String> getAccessPaths(final String itemId)
            throws IllegalArgumentException, UnknownHostException, JIException {
