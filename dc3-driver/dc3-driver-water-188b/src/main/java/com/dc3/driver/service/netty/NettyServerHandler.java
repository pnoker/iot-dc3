 ...
 * lg:[FE FE FE 68 10 03 22 10 18 20 06 73 00 81 96 90 5F 2B 2B 36 00 18 69 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 0A 68 01 00 73 B7 00 A9 16]
 *
 * @author pnoker
 */
@Slf4j
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext context, Object msg) {
        ...
        for (Long pointId : pointInfoMap.keySet()) {
            PointValue pointValue = decodePointValue(deviceId, pointId, pointInfoMap, byteBuf);
    ...
    private PointValue decodePointValue(long deviceId, long pointId, Map<Long, Map<String, AttributeInfo>> pointInfoMap, ByteBuf byteBuf) {
        ...
        log.info("DecodePointValue: hex({}),rawValue({}),convertValue({})", ByteBufUtil.hexDump(byteBuf, start, length), rawValue, value);
