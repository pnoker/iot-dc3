...
class Dnp3DriverCustomServiceImplTest {
    ...
    private Dnp3DriverCustomServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new Dnp3DriverCustomServiceImpl(driverMetadata, driverSenderService);
    }
    ...
    @Test
    void validatePointFlagsMissingPointIndex() {
