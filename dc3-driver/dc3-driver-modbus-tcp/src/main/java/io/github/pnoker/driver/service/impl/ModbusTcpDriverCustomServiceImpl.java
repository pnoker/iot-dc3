...
public class ModbusTcpDriverCustomServiceImpl implements DriverCustomService {
    ...
    private static void checkPort(Map<String, AttributeBO> driverConfig, List<ValidationReport.AttributeIssue> issues) {
    ...
    private static void checkFunctionCode(
            Map<String, AttributeBO> pointConfig, List<ValidationReport.AttributeIssue> issues) {
    ...
    private int getValueType(String type) {
        PointTypeEnum valueType = PointTypeEnum.ofCode(type);
