...
public class MessageControl implements DataConsumer {
	 ...
	 * @param messageParser a {@link com.serotonin.modbus4j.sero.messaging.MessageParser}
	 * object.
	 * @param handler a {@link com.serotonin.modbus4j.sero.messaging.RequestHandler}
	 * object.
	 * @param waitingRoomKeyFactory a
	 * {@link com.serotonin.modbus4j.sero.messaging.WaitingRoomKeyFactory} object.
	 ...
	 * </p>
	 * @param exceptionHandler a
	 * {@link com.serotonin.modbus4j.sero.messaging.MessagingExceptionHandler} object.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>timeSource</code>.
	 * </p>
	...
	/**
	 * <p>
	 * Setter for the field <code>timeSource</code>.
	 * </p>
	 ...
	 * </p>
	 * @param request a
	 * {@link com.serotonin.modbus4j.sero.messaging.OutgoingRequestMessage} object.
	 * @return a {@link com.serotonin.modbus4j.sero.messaging.IncomingResponseMessage}
	 * object.
	 * @throws java.io.IOException if any.
	 */
	 ...
	 * </p>
	 * @param response a
	 * {@link com.serotonin.modbus4j.sero.messaging.OutgoingResponseMessage} object.
	 * @throws java.io.IOException if any.
	 */
	...
	public void data(byte[] b, int len) {
		...
		while (true) {
			...
			try {
				// Mark where we are in the buffer. The entire message may not be in yet,
				// but since the parser
