 ...
 * <p>
 * NOTE: if the InputStreamEPoll instance is terminated, any running processes will be
 * destroyed without any notification to this callback.
 *
...
public interface Modbus4JInputStreamCallback {
     ...
     *
     * @param buf the content that was read. This is a shared byte array. Contents can be
     *            manipulated within this call, but the array itself should not be stored beyond the
     *            call since the contents will be changed.
    ...
    /**
     * Called if the InputStreamEPoll instance was terminated while the input stream was
     * still registered.
     */
    void terminated();
