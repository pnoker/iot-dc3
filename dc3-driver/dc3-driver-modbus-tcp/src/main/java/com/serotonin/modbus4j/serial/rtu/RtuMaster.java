...
public class RtuMaster extends SerialMaster {
    ...
    /**
     * RTU Spec: For baud greater than 19200 Message Spacing: 1.750uS
     * <p>
     * For baud less than 19200 Message Spacing: 3.5 * char time
     *
     * @param wrapper a {@link com.serotonin.modbus4j.serial.SerialPortWrapper} object.
     * @return a long.
     */
    ...
    /**
     * RTU Spec: For baud greater than 19200 Char Spacing: 750uS
     * <p>
     * For baud less than 19200 Char Spacing: 1.5 * char time
     *
     * @param wrapper a {@link com.serotonin.modbus4j.serial.SerialPortWrapper} object.
     * @return a long.
     */
    ...
    /**
     * Compute the time it takes to transmit 1 character with the provided Serial
     * Parameters.
     * <p>
     * RTU Spec: For baud greater than 19200 Char Spacing: 750uS Message Spacing: 1.750uS
     * <p>
     * For baud less than 19200 Char Spacing: 1.5 * char time Message Spacing: 3.5 * char
     * time
     *
     * @param wrapper a {@link com.serotonin.modbus4j.serial.SerialPortWrapper} object.
