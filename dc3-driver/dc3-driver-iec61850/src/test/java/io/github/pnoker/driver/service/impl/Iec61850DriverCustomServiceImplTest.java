...
class Iec61850DriverCustomServiceImplTest {
    ...
    private Iec61850DriverCustomServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new Iec61850DriverCustomServiceImpl(driverMetadata, driverSenderService);
        service.initial();
    }

    @Test
    void validateFlagsMissingHost() {
    ...
    @Test
    void validatePointFlagsMissingObjectReference() {
