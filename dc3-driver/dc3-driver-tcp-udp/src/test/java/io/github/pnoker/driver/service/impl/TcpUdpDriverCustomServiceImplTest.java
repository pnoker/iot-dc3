...
class TcpUdpDriverCustomServiceImplTest {
    ...
    private TcpUdpDriverCustomServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new TcpUdpDriverCustomServiceImpl(driverMetadata, driverSenderService);
    }
    ...
    @Test
    void validatePointFlagsMissingSendCommand() {
