...
class KnxDriverCustomServiceImplTest {
    ...
    private KnxDriverCustomServiceImpl service;

    @BeforeEach
    void setUp() {
        service = new KnxDriverCustomServiceImpl(driverMetadata, driverSenderService);
        service.initial();
    }

    @Test
    void validateFlagsMissingRemoteHost() {
    ...
    @Test
    void validatePointFlagsMissingGroupAddress() {
