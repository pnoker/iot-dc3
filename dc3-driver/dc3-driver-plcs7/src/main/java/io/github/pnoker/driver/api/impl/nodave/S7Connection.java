...
public abstract class S7Connection {
     ...
     */
    /*
     * Read a predefined set of values from the PLC. Return ok or an error state If a
     * buffer pointer is provided, data will be copied into this buffer. If it's NULL you
     * can get your data from the resultPointer in daveConnection long as you do not send
     * further requests.
     */
