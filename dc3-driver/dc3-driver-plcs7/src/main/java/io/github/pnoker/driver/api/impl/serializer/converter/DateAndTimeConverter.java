...
public final class DateAndTimeConverter extends ByteConverter {
    ...
    public <T> T extract(final Class<T> targetClass, final byte[] buffer, final int byteOffset, final int bitOffset) {
         ...
         * bitOffset);
         *
         * int ms100 = ( upperMillis >> 4 ); int ms10 = ( upperMillis & 0x0F ); int ms1 =
         * ( lowerMillis >> 4 );
         *
         * int millis = ms1 + ( 10*ms10 ) + ( 100*ms100 ); c.set(Calendar.MILLISECOND,
         * millis);
         *
    ...
    public void insert(final Object javaType, final byte[] buffer, final int byteOffset, final int bitOffset,
        ...
        /*
         * if (year < 1990 || year > 2090) throw new S7Exception("Invalid year: " + year +
         * " @ offset: " + byteOffset);
         */
         ...
         *
         * if (mStr.length() > 2) { msec100 = Integer.parseInt( mStr.substring(0, 1) );
         * msec10 = Integer.parseInt( mStr.substring(1, 2) ); msec1 = Integer.parseInt(
         * mStr.substring(2, 3) ); } else if (mStr.length() > 1) { msec10 =
         * Integer.parseInt( mStr.substring(0, 1) ); msec1 = Integer.parseInt(
         * mStr.substring(1, 2) ); } else { msec1 = Integer.parseInt( mStr.substring(0, 1)
         * ); }
         *
