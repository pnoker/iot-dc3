...
public final class S7TCPConnection extends S7BaseConnection {
     ...
     */
    public S7TCPConnection(final String host, final int rack, final int slot, final int port, final int timeout,
                           final SiemensPLCS siemensPLCS) throws S7Exception {
        this.host = host;
        this.rack = rack;
        this.slot = slot;
        this.port = port;
