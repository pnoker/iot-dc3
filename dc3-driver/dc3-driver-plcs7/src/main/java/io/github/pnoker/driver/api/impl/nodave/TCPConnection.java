...
public final class TCPConnection extends S7Connection {
    ...
    /**
     * We have our own connectPLC(), but no disconnect() Open connection to a PLC. This
     * assumes that dc is initialized by daveNewConnection and is not yet used. (or reused
     * for the same PLC ?)
     *
     * @return the int
     */
    public int connectPLC() {
        ...
        if (iface.protocol == Nodave.PROTOCOL_ISOTCP243) {
            final byte[] b243 = {(byte) 0x11, (byte) 0xE0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01,
                    (byte) 0x00, (byte) 0xC1, (byte) 0x02, (byte) 0x4D, (byte) 0x57, (byte) 0xC2, (byte) 0x02,
            ...
            final byte[] b4 = {(byte) 0x11, (byte) 0xE0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01,
                    (byte) 0x00, (byte) 0xC1, (byte) 0x02, (byte) 0x01, (byte) 0x00, (byte) 0xC2, (byte) 0x02,
                    (byte) 0x01, (byte) 0x02, (byte) 0xC0, (byte) 0x01, (byte) 0x09};
        ...
        this.readISOPacket();
        /*
         * PDU p = new PDU(msgOut, 7); p.initHeader(1); p.addParam(b61); exchange(p);
         * return (0);
         */
