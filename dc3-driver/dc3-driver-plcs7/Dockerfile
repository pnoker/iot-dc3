...
ENV GC_LOG   -verbose:gc \
             ...
             -Xlog:gc*,safepoint:dc3/logs/driver/plcs7/gc/dc3-driver-plcs7-gc.log
...
CMD mkdir -p /dc3-driver/dc3-driver-plcs7/dc3/logs/driver/plcs7/gc \
    && java ${JAVA_OPS} ${GC_LOG} -jar dc3-driver-plcs7.jar
