 ...
 * @param flag - read/write flag value
 * @returns the i18n key for the point type
 */
 ...
 * @param flag - toggle flag driving the branch
 * @returns the i18n key for the read/write flag
 */
