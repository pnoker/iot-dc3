...
<template>
  ...
  >
    <template #filters>
      <el-form-item :label="$t('eventDefinition.tool.eventName')" prop="eventName">
        <el-input
          v-model="formData.eventName"
          :placeholder="$t('eventDefinition.tool.eventNamePlaceholder')"
          class="edit-form-default"
          clearable
        />
      </el-form-item>
      <el-form-item :label="$t('eventDefinition.card.code')" prop="eventCode">
        <el-input
          v-model="formData.eventCode"
          :placeholder="$t('eventDefinition.card.code')"
          class="edit-form-default"
          clearable
        />
      </el-form-item>
