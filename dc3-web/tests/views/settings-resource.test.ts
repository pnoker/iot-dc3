...
const resourceMocks = vi.hoisted(() => ({
  addResource: vi.fn(() => Promise.resolve( true)),
  deleteResource: vi.fn(() => Promise.resolve( true)),
  listResourceTree: vi.fn(() => Promise.resolve( [])),
  updateResource: vi.fn(() => Promise.resolve( true)),
}));

vi.mock('@/api/resource', () => resourceMocks);
vi.mock('@/api/api', () => ({listApi: vi.fn(() => Promise.resolve({items: [], total: 0}))}));
vi.mock('@/api/driver', () => ({listDriverByIds: vi.fn(() => Promise.resolve({}))}));
vi.mock('@/api/device', () => ({listDeviceByIds: vi.fn(() => Promise.resolve({}))}));
vi.mock('@/api/point', () => ({listPointByIds: vi.fn(() => Promise.resolve({}))}));
vi.mock('@/api/profile', () => ({listProfileByIds: vi.fn(() => Promise.resolve({}))}));
...
vi.mock('@/api/menu', () => ({listMenuTree: vi.fn(() => Promise.resolve([]))}));
