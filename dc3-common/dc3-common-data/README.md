...
process-local latest-value source of truth. Concurrent batches sort keys before persistence to keep lock ordering
stable. Malformed messages and batches that exhaust transient retries are rejected to the configured dead-letter path.
