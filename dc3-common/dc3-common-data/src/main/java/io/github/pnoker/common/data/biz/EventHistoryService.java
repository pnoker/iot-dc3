...
public interface EventHistoryService {
     ...
     */
    Mono<String> report(Long tenantId, EventReportBO entityBO);
     ...
     */
    Mono<String> report(EventReportDTO entityDTO);
     ...
     */
    Mono<EventHistoryVO> getByRecordId(Long tenantId, String recordId);
     ...
     */
    Mono<OffsetPage<EventHistoryVO>> list(Long tenantId, EventHistoryQueryVO queryVO);
}
