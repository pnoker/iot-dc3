...
/**
 * Notification channel binding manager.
 *
 * @author pnoker
 * @version 2025.9.0
 * @since 2016.10.1
 */
@Service
public class NotifyChannelBindManagerImpl extends ServiceImpl<NotifyChannelBindMapper, NotifyChannelBindDO>
        implements NotifyChannelBindManager {
