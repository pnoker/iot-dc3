...
public final class AnalyticsModel {
    ...
    public record SeriesSelector(
            ...
            @Schema(description = "Exact device name; must resolve to exactly one device of the tenant", example = "boiler-1") String deviceName,
            @Schema(description = "Exact point name; must resolve to exactly one point (scoped to the device when deviceId is given)", example = "temp") String pointName) {
    }
    ...
    public record TimeRange(
            ...
            @Schema(description = "Relative window length in hours back from now (1..2160); ignored when fromIso is given", example = "24") Long rangeHours) {
    }
    ...
    public record QueryHistoryRequest(
            ...
            @Schema(description = "Rendering mode: RAW returns newest samples, M4 returns per-bucket first/min/max/last", example = "M4", allowableValues = {"RAW", "M4"}) String mode,
    ...
    public record ThresholdReportRequest(
            ...
            @Schema(description = "Time window; defaults to the last 24 hours") TimeRange window,
            @Schema(description = "Comparison operator against the threshold", example = "GREATER", allowableValues = {"GREATER", "LESS"}) String operator,
    ...
    public record SeriesRef(
            ...
            @Schema(description = "Human-readable label deviceName/pointName") String label) {
    }
    ...
    public record LatestValuesResponse(
            ...
            @Schema(description = "Present when the result is computed from a bounded subset") String degradation,
    ...
    public record LatestItem(
            ...
            @Schema(description = "Calculated/transformed value") String calValue,
            @Schema(description = "Numeric projection, null for non-numeric values") Double numericValue,
            @Schema(description = "NUMERIC when the value parses as a double, STRING otherwise") String valueType,
    ...
    public record HistoryResponse(
            ...
            @Schema(description = "Present when the pull was capped") String degradation,
    ...
    public record HistoryPoint(
            ...
            @Schema(description = "First value of the bucket in M4 mode") Double first,
            @Schema(description = "Minimum of the bucket in M4 mode") Double min,
            @Schema(description = "Maximum of the bucket in M4 mode") Double max,
    ...
    public record StatsResponse(
            ...
            @Schema(description = "Present when stats rest on a bounded subset") String degradation,
    ...
    public record StatItem(
            ...
            @Schema(description = "Population standard deviation of numeric values") Double stdDev,
            @Schema(description = "Minimum numeric value") Double min,
            @Schema(description = "Maximum numeric value") Double max,
            @Schema(description = "Sample count inside the window") long count,
    ...
    public record CompareResponse(
            ...
            @Schema(description = "Present when a window had no usable samples") String degradation,
    ...
    public record CompareItem(
            ...
            @Schema(description = "Percentage change versus |baseline|; null when baseline is zero") Double pctChange,
            @Schema(description = "Sample count in the current window") long currentCount,
    ...
    public record RankResponse(
            ...
            @Schema(description = "Present when the ranking is bounded") String degradation,
    ...
    public record RankItem(
            ...
            @Schema(description = "Sample count in the window") long count,
    ...
    public record TrendResponse(
            ...
            @Schema(description = "Present when a trend rests on few buckets") String degradation,
    ...
    public record TrendItem(
            ...
            @Schema(description = "Percentage change from first to last bucket; 0 when the first bucket is zero") double totalChangePct,
    ...
    public record ThresholdResponse(
            ...
            @Schema(description = "Present when intervals were capped or the pull bounded") String degradation,
    ...
    public record ThresholdItem(
            ...
            @Schema(description = "Total seconds inside exceedance intervals") long totalSeconds,
            @Schema(description = "Most extreme value observed (max for GREATER, min for LESS)") Double peak,
    ...
    public record CorrelationResponse(
            ...
            @Schema(description = "Present when computed from bucketed pulls instead of the store") String degradation,
            @Schema(description = "Pearson coefficient in [-1, 1]") double pearson,
            @Schema(description = "Number of aligned buckets") long alignedBuckets,
    ...
    public record QualityResponse(
            ...
            @Schema(description = "Present when the census was sampled") String degradation,
            @Schema(description = "Series with samples in the window") long seriesWithSamples,
            @Schema(description = "Total points of the tenant") long totalPoints,
            @Schema(description = "Reporting points as a share of all points, in percent") double coveragePct,
            @Schema(description = "Series silent beyond the configured threshold") List<SilentItem> silentSeries,
