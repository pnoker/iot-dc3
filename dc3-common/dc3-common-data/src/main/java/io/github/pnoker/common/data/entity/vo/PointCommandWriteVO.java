...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Point Command Write view object")
public class PointCommandWriteVO implements Serializable {
    ...
    @Schema(
            description = "ID of the device to write the point value to.",
            example = "1024",
    ...
    @Schema(
            description =
                    "Value to write to the data point. Must conform to the point type and any validation constraints.",
            example = "25.5",
            requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     */
    @Schema(
            description = "ID of the write command to invoke.",
            example = "4096",
            requiredMode = Schema.RequiredMode.REQUIRED)
