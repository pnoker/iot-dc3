...
public class PointValueCommandServiceImpl implements PointValueCommandService {
    ...
    public void read(PointValueReadVO entityVO) {
        ...
        rabbitTemplate.convertAndSend(RabbitConstant.TOPIC_EXCHANGE_COMMAND, RabbitConstant.ROUTING_DEVICE_COMMAND_PREFIX + driver.getServiceName(), deviceCommandDTO);
    }
