...
@Schema(
        description =
                "Tree-shaped resource view object used for hierarchical rendering; each node may carry a nested list of child resource nodes.")
public class ResourceTreeVO extends ResourceVO {

    @Schema(
            description =
                    "Ordered list of direct child resource nodes under this node; empty when the resource is a leaf.")
    @ToString.Exclude
