...
/** Canonical role-principal binding request using zero-based offset pagination. */
@Schema(description = "Role-principal binding list request using zero-based offset pagination")
 public record RolePrincipalBindOffsetRequest(
    ...
    public RolePrincipalBindOffsetRequest() { this(0L, PageRequest.DEFAULT_LIMIT, List.of(), null, null, null); }
}
