...
@Setter
@ToString
@TableName(value = "dc3_tenant_membership", autoResultMap = true)
public class TenantMembershipDO implements Serializable {
    ...
    @TableField(value = "membership_ext", typeHandler = JacksonTypeHandler.class)
