 ...
 * against the MyBatis mapper DTD. Statement defects otherwise surface only at
 * application startup or on first execution, so this gate fails the build
 * instead. No database is involved — parsing alone exercises the DTD
 * validation {@code sqlSessionFactory} performs.
 */
class AuthMapperXmlGrammarTest {
