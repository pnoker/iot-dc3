 ...
 * <p>
 * Provides suffix constants used for constructing cache keys, field names, and other
 * identifiers.
 * </p>
 *
 * @author pnoker
...
public class SuffixConstant {
    ...
    /**
     * Driver attribute config suffix: "_driver_attribute_config"
     */
    public static final String DRIVER_ATTRIBUTE_CONFIG = "_driver_attribute_config";

    /**
     * Point attribute config suffix: "_point_attribute_config"
     */
    ...
    /**
     * Host port suffix: "_host_port"
     */
    public static final String HOST_PORT = "_host_port";

    /**
     * Service name suffix: "_service_name"
     */
