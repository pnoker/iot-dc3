...
/**
 * Extension contract implemented by concrete drivers to provide protocol-specific
 * initialization, scheduling, metadata handling, and point read/write behavior.
 *
 * @author pnoker
 * @version 2025.9.0
 * @since 2022.1.0
...
public interface DriverCustomService {
     ...
     * necessary initialization operations for the driver. Developers can configure
     * essential resources or prepare the environment in this method.
     */
    void initial();
     ...
     * addition, update, or deletion operations. The specific event type (driver, device,
     * or point) is determined by {@link io.github.pnoker.common.enums.MetadataTypeEnum}.
     *
     * @param metadataEvent metadata event object containing detailed event information
     *                      {@link MetadataEventDTO}
     */
     ...
     * <p>
     * This interface is used to read point data from the specified device. Due to
     * differences in device types and communication protocols, read operations may not be
     * directly executable, please handle flexibly according to actual situations.
     * <p>
     * Note: Read operations may throw exceptions, callers need to handle exceptions
     * properly.
     *
     * @param driverConfig driver property configuration containing driver-related
     *                     configuration information
     * @param pointConfig  point property configuration containing point-related
     *                     configuration information
     ...
     * <p>
     * This interface is used to write data to a point in the specified device. Due to
     * differences in device types and communication protocols, write operations may not
     * be directly executable, please handle flexibly according to actual situations.
     * <p>
     * Note: Write operations may throw exceptions, callers need to handle exceptions
     * properly.
     *
     * @param driverConfig driver property configuration containing driver-related
     *                     configuration information
