...
/**
 * MapStruct mapper for converting command attribute configuration DTOs from gRPC
 * responses.
 *
 * @author pnoker
 * @version 2025.9.0
...
public interface GrpcCommandAttributeConfigBuilder {
    ...
    CommandAttributeConfigDTO buildDTOByGrpcDTO(GrpcCommandAttributeConfigDTO entityGrpc);

    @AfterMapping
    default void afterProcess(GrpcCommandAttributeConfigDTO entityGrpc,
                              @MappingTarget CommandAttributeConfigDTO entityDTO) {
