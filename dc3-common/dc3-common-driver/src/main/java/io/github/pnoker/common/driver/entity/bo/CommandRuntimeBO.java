...
/** Command definition installed with device metadata for protocol execution. */
public record CommandRuntimeBO(Long id, String commandName, String commandCode,
                               CommandTypeEnum commandTypeFlag, CallTypeEnum callTypeFlag,
                               Integer timeout, CommandExt commandExt,
