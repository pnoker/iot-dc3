...
/**
 * MapStruct mapper for converting event attribute definitions between gRPC DTOs and
 * internal DTOs.
 *
 * @author pnoker
 * @version 2025.9.0
...
public interface GrpcEventAttributeBuilder {
    ...
    EventAttributeDTO buildDTOByGrpcDTO(GrpcEventAttributeDTO entityGrpc);
    ...
    default void afterProcess(GrpcEventAttributeDTO entityGrpc, @MappingTarget EventAttributeDTO entityDTO) {
        ...
        JsonOptional.ofNullable(entityGrpc.getAttributeExt())
                .ifPresent(value -> entityDTO.setAttributeExt(JsonUtil.parseObject(value, EventAttributeExt.class)));
    ...
    GrpcEventAttributeDTO buildGrpcDTOByDTO(EventAttributeDTO entityDTO);

    @AfterMapping
    default void afterProcess(EventAttributeDTO entityDTO, @MappingTarget GrpcEventAttributeDTO.Builder entityGrpc) {
