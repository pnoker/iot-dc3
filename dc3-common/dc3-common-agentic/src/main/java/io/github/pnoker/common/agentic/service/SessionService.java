...
public interface SessionService {
    ...
    /**
     * Create a new session if one does not exist for the given conversation ID.
     * If a session already exists, update its operate_time.
     *
    ...
    /**
     * Delete session by conversation ID (logical delete) and clear associated chat memory.
     *
     * @param conversationId conversation ID
     */
