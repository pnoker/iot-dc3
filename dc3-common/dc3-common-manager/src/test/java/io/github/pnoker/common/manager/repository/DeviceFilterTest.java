...
class DeviceFilterTest {
    ...
    void copiesSortAndDefaultsOptionalCriteria() {
        ...
        DeviceFilter filter = new DeviceFilter(7L, "sensor", null, 20L, null,
                EnableFlagEnum.ENABLE, 0, 50, sort);
    ...
    void rejectsInvalidTenantOffsetAndLimit() {
        assertThatIllegalArgumentException().isThrownBy(() -> new DeviceFilter(0L, null, null, null,
                null, null, 0, 50, List.of()));
        assertThatIllegalArgumentException().isThrownBy(() -> new DeviceFilter(1L, null, null, null,
                null, null, -1, 50, List.of()));
        assertThatIllegalArgumentException().isThrownBy(() -> new DeviceFilter(1L, null, null, null,
                null, null, 0, 201, List.of()));
    }
}
