...
public record GroupListRequest(
        ...
        @Schema(description = "Optional group name filter", example = "production")
        String groupName,

        @Schema(description = "Optional parent group identifier", example = "100")
        Long parentGroupId,

        @Schema(description = "Optional group position filter", example = "1")
        Integer position,

        @Schema(description = "Optional group entity type filter", example = "DEVICE")
        EntityTypeEnum groupTypeFlag,
