...
/** Canonical offset-based point attribute list request. */
@Schema(description = "Command attribute list request using zero-based offset pagination")
public record PointAttributeOffsetRequest(
    ...
    public PointAttributeOffsetRequest() { this(0L, PageRequest.DEFAULT_LIMIT, List.of(), null, null, null, null, null, null); }
}
