...
/**
 * Query parameters for command attribute configuration listing.
 *
 * @author pnoker
 * @version 2025.9.0
 * @since 2016.10.1
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Command Attribute Config query parameters", example = "42")
public class CommandAttributeConfigQuery implements Serializable {
