...
/** Canonical offset-based event attribute list request. */
@Schema(description = "Command attribute list request using zero-based offset pagination")
public record EventAttributeOffsetRequest(
        ...
        Integer version) {
    /** Event attribute offset request compact constructor: normalizes the query record. */
    public EventAttributeOffsetRequest {
    ...
    /** event attribute offset request. */
    public EventAttributeOffsetRequest() {
