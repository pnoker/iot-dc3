...
@Schema(description = "Command attribute config list request using zero-based offset pagination")
public record CommandAttributeConfigOffsetRequest(
        ...
        @Schema(description = "Command attribute identifier filter") Long attributeId,
        @Schema(description = "Device identifier filter") Long deviceId,
        @Schema(description = "Command identifier filter") Long commandId,
    ...
    public CommandAttributeConfigOffsetRequest {
        ...
        Set<String> fields = Set.of("id", "attributeId", "deviceId", "commandId", "createTime", "operateTime", "version");
    ...
    public CommandAttributeConfigOffsetRequest() { this(0L, PageRequest.DEFAULT_LIMIT, List.of(), null, null, null, null, null); }
}
