...
public class DriverAttributeVO extends BaseVO {
    ...
    @Schema(
            description =
                    "Driver attribute name. Unique name within a driver for identifying a configurable driver property.",
    ...
    @NotBlank(
            ...
            groups = {Add.class})
    @Schema(
            description = "Driver attribute code. Stable business identifier; must not change once deployed.",
     ...
     */
    @Schema(
            description = "Driver attribute data type: STRING, BYTE, SHORT, INT, LONG, FLOAT, DOUBLE, or BOOLEAN.",
            example = "INT")
