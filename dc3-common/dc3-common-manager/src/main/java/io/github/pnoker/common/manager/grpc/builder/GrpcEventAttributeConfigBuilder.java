...
public interface GrpcEventAttributeConfigBuilder {
     ...
     * BO to Grpc DTO
     *
     * @param entityBO EventAttributeConfigBO
     * @return GrpcEventAttributeConfigDTO
     */
    ...
    default void afterProcess(
            EventAttributeConfigBO entityBO, @MappingTarget GrpcEventAttributeConfigDTO.Builder entityGrpc) {
