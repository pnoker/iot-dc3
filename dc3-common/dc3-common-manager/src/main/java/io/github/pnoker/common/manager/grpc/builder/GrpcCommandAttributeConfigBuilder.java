...
/**
 * GrpcCommandAttributeConfig Builder
 *
 * @author pnoker
 * @version 2025.9.0
 * @since 2016.10.1
...
public interface GrpcCommandAttributeConfigBuilder {
     ...
     * BO to Grpc DTO
     *
     * @param entityBO CommandAttributeConfigBO
     * @return GrpcCommandAttributeConfigDTO
     */
    ...
    GrpcCommandAttributeConfigDTO buildGrpcDTOByBO(CommandAttributeConfigBO entityBO);
