...
/**
 * Query parameters for command attribute listing.
 *
 * @author pnoker
 * @version 2025.9.0
 * @since 2016.10.1
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Command Attribute query parameters", example = "42")
public class CommandAttributeQuery implements Serializable {
     ...
     * Type
     */
    @Schema(description = "Filter by attribute data type: STRING, BYTE, SHORT, INT, LONG, FLOAT, DOUBLE, or BOOLEAN.", example = "BYTE")
