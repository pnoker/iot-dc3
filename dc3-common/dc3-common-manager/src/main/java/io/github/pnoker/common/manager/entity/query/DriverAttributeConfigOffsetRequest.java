...
public record DriverAttributeConfigOffsetRequest(
        ...
        @Schema(description = "Driver attribute identifier filter")
        Long attributeId,
        ...
        Integer version) {
    /** Driver attribute config offset request compact constructor: normalizes the query record. */
    public DriverAttributeConfigOffsetRequest {
        ...
        Set<String> fields = Set.of("id", "attributeId", "deviceId", "createTime", "operateTime", "version");
    ...
    /** driver attribute config offset request. */
    public DriverAttributeConfigOffsetRequest() {
