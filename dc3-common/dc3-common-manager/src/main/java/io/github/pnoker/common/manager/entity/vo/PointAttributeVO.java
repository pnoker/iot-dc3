...
public class PointAttributeVO extends BaseVO {
    ...
    @Schema(description = "Point attribute code. Stable business identifier; must not change once deployed.", example = "REG_ADDR")
     ...
     *
     */
    @Schema(description = "Default attribute value when no per-device configuration is provided.", example = "40001")
     ...
     *
     */
    @Schema(description = "Point attribute extension information, serialized as JSON for custom metadata.")
