...
/** Canonical offset-based event list request. */
@Schema(description = "Event list request using zero-based offset pagination")
public record EventOffsetRequest(
        ...
        @Schema(description = "Partial event name filter") String eventName,
        @Schema(description = "Exact event code filter") String eventCode,
        @Schema(description = "Event type filter") EventTypeFlagEnum eventTypeFlag,
        @Schema(description = "Event severity filter") EventLevelEnum eventLevelFlag,
    ...
    public EventOffsetRequest {
        ...
        Set<String> fields = Set.of("id", "eventName", "eventCode", "createTime", "operateTime", "version");
    ...
    public EventOffsetRequest() { this(0L, PageRequest.DEFAULT_LIMIT, List.of(), null, null, null, null, null, null, null, null); }
}
