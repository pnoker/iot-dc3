...
public record DictionaryListRequest(
        ...
        @Schema(description = "Maximum number of options", example = "50")
        Integer limit,

        @Schema(description = "Stable option sort fields: label or value")
        List<SortSpec> sort,

        @Schema(description = "Partial display-label filter")
        String label,

        @Schema(description = "Parent entity identifier for dependent options")
        Long parentId) {
