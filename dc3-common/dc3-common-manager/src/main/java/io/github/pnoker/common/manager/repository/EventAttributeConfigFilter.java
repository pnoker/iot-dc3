...
/** Tenant-scoped query filter for event attribute config records. */
public record EventAttributeConfigFilter(
        Long tenantId,
        Long attributeId,
        Long deviceId,
        Long eventId,
    ...
    private static final Set<String> SORT_FIELDS =
            Set.of("id", "attributeId", "deviceId", "eventId", "createTime", "operateTime", "version");

    /** Event attribute config filter compact constructor: normalizes the filter record. */
