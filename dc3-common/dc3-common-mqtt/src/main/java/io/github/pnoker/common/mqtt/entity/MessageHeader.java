 ...
 * <p>
 * Represents header information for MQTT messages in IoT DC3 platform. Contains message
 * metadata including MQTT ID, QoS level, topic, duplicate flag, retained flag, and
 * timestamp.
 * </p>
 *
 * @author pnoker
