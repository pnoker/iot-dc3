 ...
 * <p>
 * Uses {@link DefaultConstant#NULL_INT NULL_INT} as "not set" for
 * {@code pointTypeFlag} / {@code rwFlag} / {@code profileId}, matching
...
public class FacadeGrpcPointBuilder {
    ...
    public GrpcPagePointQuery toGrpcPageQuery(FacadePointQuery query) {
        ...
        Optional.ofNullable(query.getPointTypeFlag()).ifPresentOrElse(
                value -> builder.setPointTypeFlag(value.getIndex()),
                () -> builder.setPointTypeFlag(DefaultConstant.NULL_INT)
        );
        Optional.ofNullable(query.getRwFlag()).ifPresentOrElse(
                value -> builder.setRwFlag(value.getIndex()),
                () -> builder.setRwFlag(DefaultConstant.NULL_INT)
        );
        Optional.ofNullable(query.getProfileId()).ifPresentOrElse(
                builder::setProfileId,
                () -> builder.setProfileId(DefaultConstant.NULL_INT)
        );
