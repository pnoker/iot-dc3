...
public record FacadeCommandOffsetQuery(
        Long tenantId,
        String commandName,
        String commandCode,
        CommandTypeEnum commandTypeFlag,
        CallTypeEnum callTypeFlag,
        Long profileId,
        ...
        int limit,
        List<SortSpec> sort) {
    /** Facade command offset query compact constructor: normalizes the query record. */
