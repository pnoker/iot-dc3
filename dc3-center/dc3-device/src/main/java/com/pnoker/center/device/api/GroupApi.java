...
import com.pnoker.api.center.device.feign.GroupClient;
import com.pnoker.center.device.service.GroupService;
...
@Slf4j
@RestController
@RequestMapping(Common.Service.DC3_DEVICE_GROUP_URL_PREFIX)
