...
import com.pnoker.api.center.device.feign.DeviceClient;
import com.pnoker.center.device.service.DeviceService;
...
@Slf4j
@RestController
@RequestMapping(Common.Service.DC3_DEVICE_DEVICE_URL_PREFIX)
