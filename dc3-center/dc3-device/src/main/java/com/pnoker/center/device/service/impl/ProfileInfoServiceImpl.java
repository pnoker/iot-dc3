...
import com.pnoker.center.device.mapper.ProfileInfoMapper;
import com.pnoker.center.device.service.DriverService;
import com.pnoker.center.device.service.ProfileInfoService;
...
public class ProfileInfoServiceImpl implements ProfileInfoService {
    ...
    @Override
    @Cacheable(value = Common.Cache.PROFILE_INFO_ID, key = "#id", unless = "#result==null")
    public ProfileInfo selectById(Long id) {
        return profileInfoMapper.selectById(id);
    }

    @Override
    @Cacheable(value = Common.Cache.PROFILE_INFO_NAME, key = "#name", unless = "#result==null")
