...
import com.pnoker.commont.security.component.Dc3WebResponseExceptionTranslator;
import com.pnoker.commont.security.service.Dc3ClientDetailsService;
import com.pnoker.commont.security.service.Dc3User;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            Dc3User pigUser = (Dc3User) authentication.getUserAuthentication().getPrincipal();
