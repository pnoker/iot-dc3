...
import com.pnoker.center.manager.mapper.ConnectInfoMapper;
...
public class ConnectInfoServiceImpl implements ConnectInfoService {
    ...
    @Caching(
            put = {
                    @CachePut(value = Common.Cache.CONNECT_INFO + Common.Cache.ID, key = "#connectInfo.id", condition = "#result!=null"),
                    @CachePut(value = Common.Cache.CONNECT_INFO + Common.Cache.NAME, key = "#connectInfo.name", condition = "#result!=null")
            },
            evict = {
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.DIC, allEntries = true, condition = "#result!=null"),
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.LIST, allEntries = true, condition = "#result!=null")
            }
    )
    ...
    @Caching(
            evict = {
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.ID, key = "#id", condition = "#result==true"),
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.NAME, allEntries = true, condition = "#result==true"),
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.DIC, allEntries = true, condition = "#result==true"),
                    @CacheEvict(value = Common.Cache.CONNECT_INFO + Common.Cache.LIST, allEntries = true, condition = "#result==true")
            }
    )
    ...
    @Override
    @Cacheable(value = Common.Cache.CONNECT_INFO + Common.Cache.ID, key = "#id", unless = "#result==null")
    public ConnectInfo selectById(Long id) {
        return connectInfoMapper.selectById(id);
    }

    @Override
    @Cacheable(value = Common.Cache.CONNECT_INFO + Common.Cache.NAME, key = "#name", unless = "#result==null")
    ...
    @Override
    @Cacheable(value = Common.Cache.CONNECT_INFO + Common.Cache.LIST, keyGenerator = "commonKeyGenerator", unless = "#result==null")
    ...
    @Override
    @Cacheable(value = Common.Cache.CONNECT_INFO + Common.Cache.DIC, key = "'connection_info_dic'", unless = "#result==null")
