...
import com.dc3.center.data.save.opentsdb.service.OpenTsdbService;
...
@Slf4j
@Service
public class PointValueHandleServiceImpl implements PointValueHandleService {
    ...
    public void postHandle(PointValue pointValue) {
        openTsdbService.savePointValue(pointValue);
    }

    @Override
    public void postHandle(List<PointValue> pointValues) {
        openTsdbService.savePointValues(pointValues);
    }
