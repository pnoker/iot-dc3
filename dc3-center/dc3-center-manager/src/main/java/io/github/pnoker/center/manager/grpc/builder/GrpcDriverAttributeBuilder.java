...
public interface GrpcDriverAttributeBuilder {
    ...
    default void afterProcess(DriverAttributeBO entityBO, @MappingTarget GrpcDriverAttributeDTO.Builder entityGrpc) {
        ...
        Optional.ofNullable(entityBO.getAttributeTypeFlag()).ifPresentOrElse(value -> entityGrpc.setAttributeTypeFlag(value.getIndex()), () -> entityGrpc.setAttributeTypeFlag(DefaultConstant.DEFAULT_NULL_INT_VALUE));
