...
public interface CommonConstant {
    ...
    interface Algorithm {
         ...
         * 默认密码
         */
        String DEFAULT_PASSWORD = "a12345";
    ...
    interface Storage {
         ...
         * 设备数据存储集合前缀
         */
        String POINT_VALUE_PREFIX = CacheConstant.Entity.POINT + io.github.ponker.center.ekuiper.constant.CacheConstant.Suffix.VALUE + Symbol.UNDERSCORE;
    }
    ...
    interface RepositoryStrategy {
        ...
        String REPOSITORY_STRATEGY_MQTT = "mqtt";
    }
}
