...
@Slf4j
@Component
public class RtmpDbsFeignClientHystrix implements FallbackFactory<RtmpDbsFeignClient> {
    ...
    public RtmpDbsFeignClient create(Throwable throwable) {
        ...
        log.error("RtmpDbsFeignClient:{},hystrix服务降级处理", message, throwable);
