...
import com.pnoker.api.center.device.hystrix.LabelClientHystrix;
 ...
 * @author pnoker
 */
@FeignClient(path = Common.Service.DC3_DEVICE_LABEL_URL_PREFIX, name = Common.Service.DC3_DEVICE, fallbackFactory = LabelClientHystrix.class)
