...
import com.pnoker.api.center.device.hystrix.DeviceClientHystrix;
 ...
 * @author pnoker
 */
@FeignClient(path = Common.Service.DC3_DEVICE_DEVICE_URL_PREFIX, name = Common.Service.DC3_DEVICE, fallbackFactory = DeviceClientHystrix.class)
