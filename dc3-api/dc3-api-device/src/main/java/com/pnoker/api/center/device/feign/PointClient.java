...
import com.pnoker.api.center.device.hystrix.PointClientHystrix;
 ...
 * @author pnoker
 */
@FeignClient(path = Common.Service.DC3_DEVICE_POINT_URL_PREFIX, name = Common.Service.DC3_DEVICE, fallbackFactory = PointClientHystrix.class)
