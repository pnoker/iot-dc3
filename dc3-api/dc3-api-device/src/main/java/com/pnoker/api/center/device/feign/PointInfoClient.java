...
import com.pnoker.api.center.device.hystrix.PointInfoClientHystrix;
 ...
 * @author pnoker
 */
@FeignClient(path = Common.Service.DC3_DEVICE_POINT_INFO_URL_PREFIX, name = Common.Service.DC3_DEVICE, fallbackFactory = PointInfoClientHystrix.class)
