 ...
 * @since 2022.1.0
 */
@FeignClient(path = ManagerServiceConstant.DRIVER_INFO_URL_PREFIX, name = ManagerServiceConstant.SERVICE_NAME, fallbackFactory = DriverInfoClientFallback.class)
