...
import com.pnoker.api.device.manager.hystrix.ProfileInfoClientHystrix;
 ...
 * @author pnoker
 */
@FeignClient(path = Common.Service.DC3_MANAGER_PROFILE_INFO_URL_PREFIX, name = Common.Service.DC3_MANAGER, fallbackFactory = ProfileInfoClientHystrix.class)
