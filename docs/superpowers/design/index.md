...
这些材料属于工程资料，不作为公开功能说明。用户视角的当前能力以 [快速开始](../../quickstart/)、[操作手册](../../operation/)
和 [模块清单](../../modules/) 为准。
...
- [Gateway MCP 服务设计](mcp-server.md) - 在 Gateway 上构建 MCP Server，将 OpenAPI 接口通过标准 MCP 协议暴露给 AI
  Agent，复用现有权限体系实现多租户工具过滤
