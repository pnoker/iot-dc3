    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1040 440">
        <defs>
          ...
          <filter id="cr-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="7"/>
          </filter>
        </defs>

        <line marker-end="url(#cr-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="200" x2="340" y1="215"
              y2="205"/>
        ...
        <path d="M190,74 Q430,28 690,200" fill="none" marker-end="url(#cr-ah)" stroke="var(--dc3-arrow)"
              stroke-width="1.5"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="440" y="42">{{ s.call }}</text>
        <line marker-end="url(#cr-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="780" x2="780" y1="285"
              y2="330"/>
        ...
        <rect fill="var(--dc3-fe-stroke)" filter="url(#cr-glow)" height="115" opacity="0.22" rx="14" width="220" x="330"
              y="145"/>
        ...
        <rect fill="var(--dc3-fe-fill)" height="95" rx="10" stroke="var(--dc3-fe-stroke)" stroke-width="2.5" width="200"
              x="340" y="155"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="16" font-weight="700" text-anchor="middle" x="440"
              y="190">{{ s.command }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="60" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="190"
              x="680" y="55"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="775" y="82">{{
            s.param
          }}
        </text>
        ...
        <path d="M690,175 a80,15 0 0 0 180,0 v95 a80,15 0 0 1 -180,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="11.5" text-anchor="middle" x="780" y="225">{{
            s.hist
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="62" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="190" x="680" y="330"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="775" y="357">{{
            s.driver
          }}
        </text>
