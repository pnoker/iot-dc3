    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1000 360">
        <defs>
          ...
          <filter id="ds-glow" height="180%" width="180%" x="-40%" y="-40%">
        ...
        <!-- scanner -> state -->
        <line marker-end="url(#ds-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="580" x2="800" y1="250"
              y2="165"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="720" y="198">{{ s.query }}</text>
        <line marker-end="url(#ds-ah)" stroke="var(--dc3-rose-stroke)" stroke-dasharray="5,4" stroke-width="1.5"
              x1="460" x2="740" y1="250" y2="150"/>
        ...
        <rect fill="var(--dc3-bus-fill)" height="62" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="200" x="40" y="60"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="140" y="88">{{
            s.driver
          }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="70" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="200"
              x="340" y="55"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="440" y="84">{{
            s.dc
          }}
        </text>
        ...
        <rect fill="var(--dc3-db-stroke)" filter="url(#ds-glow)" height="130" opacity="0.18" rx="14" width="240" x="660"
              y="35"/>
        <path d="M690,60 a90,16 0 0 0 180,0 v90 a90,16 0 0 1 -180,0 z" fill="var(--vp-c-bg)"/>
        <path d="M690,60 a90,16 0 0 0 180,0 v90 a90,16 0 0 1 -180,0 z" fill="var(--dc3-db-fill)"
              stroke="var(--dc3-db-stroke)" stroke-width="2"/>
        <ellipse cx="780" cy="60" fill="none" rx="90" ry="16" stroke="var(--dc3-db-stroke)" stroke-width="2"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13.5" font-weight="700" text-anchor="middle" x="780"
              y="108">{{ s.state }}
        </text>
        ...
        <rect fill="var(--dc3-amber-fill)" height="62" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="240" x="340" y="225"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="460" y="252">{{
            s.scan
          }}
        </text>
