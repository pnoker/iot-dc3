  ...
  <DiagramFrame>
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1180 340">
        ...
        <line marker-end="url(#acf-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="220" x2="290" y1="155"
              y2="155"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="255" y="147">{{ s.e1 }}</text>
        <line marker-end="url(#acf-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="520" x2="560" y1="150"
              y2="155"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="540" y="142">{{ s.e2 }}</text>
        <line marker-end="url(#acf-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="780" x2="830" y1="155"
              y2="155"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="805" y="147">{{ s.e3 }}</text>
        <line marker-end="url(#acf-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="940" x2="940" y1="205"
              y2="260"/>
        ...
        <rect fill="var(--dc3-amber-fill)" height="70" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="200" x="20" y="120"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="120" y="148">{{
            s.yml
          }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="80" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="230"
              x="290" y="115"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="405" y="145">{{
            s.mgr
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="70" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="220"
              x="560" y="120"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="670" y="148">{{
            s.ui
          }}
        </text>
        ...
        <path d="M830,110 a100,16 0 0 0 200,0 v90 a100,16 0 0 1 -200,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="930" y="160">{{
            s.cfg
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="60" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="220" x="830" y="260"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="940" y="286">{{
            s.rt
          }}
        </text>
