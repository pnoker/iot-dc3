    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1000 420">
        <defs>
          ...
          <filter id="ptr-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="6"/>
          </filter>
        </defs>

        <!-- edges (behind boxes) -->
        <line marker-end="url(#ptr-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="190" x2="240" y1="215"
              y2="215"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="215" y="207">{{ s.belongs }}</text>
        <line marker-end="url(#ptr-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="410" x2="500" y1="190"
              y2="120"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="445" y="150">{{ s.defines }}</text>
        <line marker-end="url(#ptr-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="410" x2="500" y1="230"
              y2="235"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="455" y="227">{{ s.defines }}</text>
        <line marker-end="url(#ptr-ah)" stroke="var(--dc3-arrow)" stroke-dasharray="5,4" stroke-width="1.5" x1="690"
              x2="800" y1="120" y2="195"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="762" y="148">{{ s.fk }}</text>
        <path d="M120,247 Q120,362 500,362 Q820,362 868,282" fill="none" marker-end="url(#ptr-ah)"
        ...
        <rect fill="var(--dc3-ext-fill)" height="62" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="140" x="50" y="185"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="120" y="211">{{
            s.device
          }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="70" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="170"
              x="240" y="180"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="325" y="210">{{
            s.profile
          }}
        </text>
        ...
        <!-- point (HERO) -->
        <rect fill="var(--dc3-fe-stroke)" filter="url(#ptr-glow)" height="90" opacity="0.28" rx="14" width="210" x="490"
              y="40"/>
        <rect fill="var(--vp-c-bg)" height="70" rx="10" width="190" x="500" y="50"/>
        <rect fill="var(--dc3-fe-fill)" height="70" rx="10" stroke="var(--dc3-fe-stroke)" stroke-width="2.5" width="190"
              x="500" y="50"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="16" font-weight="700" text-anchor="middle" x="595"
              y="82">{{ s.point }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="60" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="190"
              x="500" y="205"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="595" y="231">
          {{ s.command }}
        </text>
        ...
        <path d="M800,170 a70,16 0 0 0 140,0 v110 a70,16 0 0 1 -140,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="870" y="226">{{
            s.pvName
          }}
        </text>
