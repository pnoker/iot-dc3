...
const DICT = {
  ...
  en: {
    ...
    timeout: 'TIMEOUT',
    dead: 'DEAD',
    t1: 'publisher confirm (broker ACK)',
    t2: 'driver confirms success',
    t3: 'driver reports failure',
    t4: 'application-level timeout',
    t5: 'expireAt already passed at consume',
    t6: 'hit driver dedup cache',
    t7: 'routed to dead-letter queue (DLX)'
  }
} as const
  ...
  <DiagramFrame>
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1180 440">
        ...
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="49" x2="100" y1="215"
              y2="215"/>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="240" x2="300" y1="215"
              y2="215"/>
        <text fill="var(--dc3-arrow-label)" font-size="9.5" text-anchor="middle" x="270" y="207">{{ s.t1 }}</text>
        <!-- SENT -> 6 terminal states -->
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="540" y1="200"
              y2="110"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="468" y="148">{{ s.t2 }}</text>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="540" y1="222"
              y2="220"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="468" y="240">{{ s.t4 }}</text>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="540" y1="240"
              y2="330"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="468" y="300">{{ s.t5 }}</text>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="820" y1="200"
              y2="110"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="700" y="128">{{ s.t3 }}</text>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="820" y1="228"
              y2="220"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="700" y="245">{{ s.t6 }}</text>
        <line marker-end="url(#dcs-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="440" x2="820" y1="245"
              y2="330"/>
        <text fill="var(--dc3-arrow-label)" font-size="8.5" text-anchor="middle" x="700" y="305">{{ s.t7 }}</text>
        <!-- PENDING -->
