...
const DICT = {
  ...
  en: {
    ...
    driver: 'Driver',
    driverSub1: 'dc3-driver-*',
    driverSub2: 'protocol adapter',
    mgr: 'Manager Center',
    mgrSub: 'registry',
    da: 'DriverAttribute',
    daSub: 'driver config items',
    device: 'Device',
    deviceSub: '1..N',
    profile: 'Profile',
    profileSub: 'root',
    point: 'Point',
    pointSub: 'sampled item',
    dac: 'DriverAttributeConfig',
    dacSub: 'connection config',
    pv: 'PointValue',
    e1: 'registers identity',
    e2: 'declares attrs',
    e3: 'hosts',
    e4: 'belongs to',
    e5: 'fills per decl',
    e6: 'defines',
    e7: 'collects & translates'
  }
} as const
    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1120 480">
        <defs>
          ...
          <filter id="drv-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="7"/>
          </filter>
        </defs>

        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="230" x2="340" y1="215"
              y2="110"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="262" y="150">{{ s.e1 }}</text>
        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="230" x2="340" y1="240"
              y2="240"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="285" y="232">{{ s.e2 }}</text>
        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="230" x2="340" y1="265"
              y2="390"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="262" y="345">{{ s.e3 }}</text>
        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="520" x2="640" y1="380"
              y2="180"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="565" y="272">{{ s.e4 }}</text>
        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="520" x2="640" y1="400"
              y2="390"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="580" y="392">{{ s.e5 }}</text>
        <line marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="725" x2="720" y1="212"
              y2="250"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="762" y="234">{{ s.e6 }}</text>
        <path d="M230,275 Q560,470 920,290" fill="none" marker-end="url(#drv-ah)" stroke="var(--dc3-arrow)"
              stroke-width="1.5"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="575" y="462">{{ s.e7 }}</text>

        <rect fill="var(--dc3-bus-stroke)" filter="url(#drv-glow)" height="110" opacity="0.2" rx="14" width="200" x="40"
              y="180"/>
        <rect fill="var(--vp-c-bg)" height="90" rx="10" width="180" x="50" y="190"/>
        <rect fill="var(--dc3-bus-fill)" height="90" rx="10" stroke="var(--dc3-bus-stroke)" stroke-width="2.5"
              width="180" x="50" y="190"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="15.5" font-weight="700" text-anchor="middle" x="140"
              y="225">{{ s.driver }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="62" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="200"
              x="340" y="80"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="440" y="108">{{
            s.mgr
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="62" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="220"
              x="340" y="210"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="450" y="237">{{
            s.da
          }}
        </text>
        ...
        <rect fill="var(--dc3-ext-fill)" height="62" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="180" x="340" y="360"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="430" y="387">{{
            s.device
          }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="62" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="170"
              x="640" y="150"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="725" y="178">{{
            s.profile
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="62" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="160"
              x="640" y="250"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="720" y="278">{{
            s.point
          }}
        </text>
        ...
        <rect fill="var(--dc3-amber-fill)" height="62" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="220" x="640" y="360"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="11.5" text-anchor="middle" x="750" y="387">{{
            s.dac
          }}
        </text>
        ...
        <path d="M920,200 a80,16 0 0 0 160,0 v100 a80,16 0 0 1 -160,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="11.5" text-anchor="middle" x="1000" y="255">{{
            s.pv
          }}
        </text>
      </svg>
