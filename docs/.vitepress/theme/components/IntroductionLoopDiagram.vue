    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1080 430">
        <defs>
          ...
          <filter id="il-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="8"/>
          </filter>
        </defs>

        <!-- data up -->
        <line marker-end="url(#il-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="190" x2="290" y1="195"
              y2="195"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="240" y="187">{{ s.e1 }}</text>
        <line marker-end="url(#il-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="470" x2="560" y1="190"
              y2="190"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="515" y="182">{{ s.e2 }}</text>
        <line marker-end="url(#il-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="760" x2="850" y1="180"
              y2="180"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="805" y="172">{{ s.e3 }}</text>
        <!-- AI <-> DC -->
        <line marker-end="url(#il-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="620" x2="620" y1="330"
              y2="244"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="668" y="292">{{ s.e4 }}</text>
        <line marker-end="url(#il-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="700" x2="700" y1="330"
              y2="244"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="748" y="320">{{ s.e5 }}</text>
        <!-- command down (DC -> Driver -> Device) -->
        <path d="M660,244 Q660,210 470,225" fill="none" marker-end="url(#il-ah)" stroke="var(--dc3-arrow)"
              stroke-dasharray="5,4" stroke-width="1.5"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="565" y="222">{{ s.e6 }}</text>
        <path d="M290,210 Q240,210 190,210" fill="none" marker-end="url(#il-ah)" stroke="var(--dc3-arrow)"
              stroke-dasharray="5,4" stroke-width="1.5"/>
        ...
        <rect fill="var(--dc3-ext-fill)" height="70" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="150" x="40" y="160"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="115" y="190">{{
            s.dev
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="70" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="180" x="290" y="160"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12" text-anchor="middle" x="380" y="190">{{
            s.drv
          }}
        </text>

        <rect fill="var(--dc3-be-stroke)" filter="url(#il-glow)" height="92" opacity="0.2" rx="14" width="200" x="560"
              y="150"/>
        ...
        <rect fill="var(--dc3-be-fill)" height="92" rx="10" stroke="var(--dc3-be-stroke)" stroke-width="2.5" width="200"
              x="560" y="150"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="14" font-weight="700" text-anchor="middle" x="660"
              y="190">{{ s.dc }}
        </text>
        <text fill="var(--dc3-text2)" font-size="9.5" text-anchor="middle" x="660" y="212">位号值 · 命令分发 · 告警
        </text>

        <path d="M850,130 a85,16 0 0 0 170,0 v100 a85,16 0 0 1 -170,0 z" fill="var(--vp-c-bg)"/>
        <path d="M850,130 a85,16 0 0 0 170,0 v100 a85,16 0 0 1 -170,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12" text-anchor="middle" x="935" y="180">{{
            s.store
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="70" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="220"
              x="550" y="330"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="660" y="358">{{
            s.ai
          }}
        </text>
