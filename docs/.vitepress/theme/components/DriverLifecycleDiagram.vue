...
const DICT = {
  ...
  en: {
    ...
    start: 'Driver process starts',
    startSub: 'startup',
    run: 'DriverInitRunner.run()',
    runSub: 'register + heartbeat orchestration',
    mgr: 'Manager Center',
    mgrSub: 'registry',
    meta1: 'dc3_driver /',
    meta2: 'dc3_driver_attribute',
    hb: 'DriverHealth',
    hbSub: 'periodic heartbeat',
    state: 'dc3_entity_state',
    stateSub: 'driver=3 · online',
    off: 'marked offline',
    e1: 'RegisterBO w/ backoff retry',
    e2: 'persist',
    e3: 'periodic heartbeat',
    e4: 'renew lease 45s',
    e5: 'lease expired'
  }
} as const
    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1100 520">
        <defs>
          ...
          <filter id="dl-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="7"/>
          </filter>
        </defs>

        <line marker-end="url(#dl-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="180" x2="250" y1="257"
              y2="255"/>
        <line marker-end="url(#dl-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="480" x2="560" y1="230"
              y2="115"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="553" y="166">{{ s.e1 }}</text>
        <line marker-end="url(#dl-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="770" x2="850" y1="115"
              y2="115"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="810" y="107">{{ s.e2 }}</text>
        <line marker-end="url(#dl-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="480" x2="560" y1="275"
              y2="390"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="553" y="346">{{ s.e3 }}</text>
        <line marker-end="url(#dl-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="780" x2="850" y1="390"
              y2="390"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="815" y="382">{{ s.e4 }}</text>
        <line marker-end="url(#dl-ah)" stroke="var(--dc3-rose-stroke)" stroke-dasharray="5,4" stroke-width="1.5"
              x1="950" x2="930" y1="455" y2="470"/>
        ...
        <rect fill="var(--dc3-ext-fill)" height="60" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="150" x="30" y="225"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="105" y="251">{{
            s.start
          }}
        </text>
        <text fill="var(--dc3-text2)" font-size="10" text-anchor="middle" x="105" y="269">{{ s.startSub }}</text>

        <rect fill="var(--dc3-be-stroke)" filter="url(#dl-glow)" height="105" opacity="0.2" rx="14" width="250" x="240"
              y="200"/>
        <rect fill="var(--vp-c-bg)" height="85" rx="10" width="230" x="250" y="210"/>
        <rect fill="var(--dc3-be-fill)" height="85" rx="10" stroke="var(--dc3-be-stroke)" stroke-width="2.5" width="230"
              x="250" y="210"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" font-weight="700" text-anchor="middle" x="365"
              y="245">{{ s.run }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="65" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="210"
              x="560" y="82"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="665" y="110">{{
            s.mgr
          }}
        </text>
        ...
        <path d="M850,65 a100,16 0 0 0 200,0 v95 a100,16 0 0 1 -200,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="11" text-anchor="middle" x="950" y="113">{{
            s.meta1
          }}
        </text>
        ...
        <rect fill="var(--dc3-amber-fill)" height="60" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="220" x="560" y="360"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="670" y="387">{{
            s.hb
          }}
        </text>
        ...
        <path d="M850,335 a100,16 0 0 0 200,0 v110 a100,16 0 0 1 -200,0 z" fill="var(--dc3-db-fill)"
              stroke="var(--dc3-db-stroke)" stroke-width="1.5"/>
        <ellipse cx="950" cy="335" fill="none" rx="100" ry="16" stroke="var(--dc3-db-stroke)" stroke-width="1.5"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="11.5" text-anchor="middle" x="950" y="390">{{
            s.state
          }}
        </text>
        ...
        <rect fill="var(--dc3-rose-fill)" height="45" rx="8" stroke="var(--dc3-rose-stroke)" stroke-width="1.5"
              width="240" x="810" y="470"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="930" y="498">{{
            s.off
          }}
        </text>
      </svg>
