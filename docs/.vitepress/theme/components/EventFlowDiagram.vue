  ...
  <DiagramFrame>
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1080 440">
        ...
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="140" x2="190" y1="200"
              y2="200"/>
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="390" x2="440" y1="200"
              y2="200"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="415" y="192">{{ s.dto }}</text>
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="620" x2="660" y1="200"
              y2="200"/>
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="880" x2="930" y1="180"
              y2="190"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="905" y="172">{{ s.persist }}</text>
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="770" x2="770" y1="240"
              y2="320"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="816" y="284">{{ s.eval }}</text>
        <line marker-end="url(#ef-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="880" x2="930" y1="350"
              y2="350"/>
        ...
        <rect fill="var(--dc3-ext-fill)" height="55" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="110" x="30" y="172"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="85" y="196">{{
            s.dev
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="65" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="200" x="190" y="168"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="290" y="194">{{
            s.drv
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="55" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="180" x="440" y="172"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12" text-anchor="middle" x="530" y="194">{{
            s.mq1
          }}
        </text>
        ...
        <rect fill="var(--dc3-be-fill)" height="75" rx="8" stroke="var(--dc3-be-stroke)" stroke-width="1.5" width="220"
              x="660" y="165"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="770" y="192">{{
            s.dc
          }}
        </text>
        ...
        <path d="M930,150 a75,15 0 0 0 150,0 v95 a75,15 0 0 1 -150,0 z" fill="var(--dc3-db-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="10.5" text-anchor="middle" x="1005" y="205">{{
            s.hist
          }}
        </text>
        ...
        <rect fill="var(--dc3-amber-fill)" height="60" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="220" x="660" y="320"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="770" y="346">{{
            s.rule
          }}
        </text>
        ...
        <path d="M930,310 a75,15 0 0 0 150,0 v85 a75,15 0 0 1 -150,0 z" fill="var(--dc3-rose-fill)"
        ...
        <text class="d-name" fill="var(--dc3-box-name)" font-size="10.5" text-anchor="middle" x="1005" y="360">
          {{ s.alarm }}
        </text>
      </svg>
    </div>
