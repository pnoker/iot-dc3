    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 980 320">
        <defs>
          ...
          <filter id="ta-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="7"/>
          </filter>
        </defs>

        <line marker-end="url(#ta-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="230" x2="310" y1="180"
              y2="180"/>
        <line marker-end="url(#ta-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="560" x2="640" y1="160"
              y2="100"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="610" y="120">{{ s.e1 }}</text>
        <line marker-end="url(#ta-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="560" x2="640" y1="210"
              y2="260"/>
        ...
        <rect fill="var(--dc3-ext-fill)" height="60" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="200" x="30" y="150"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12" text-anchor="middle" x="130" y="178">{{
            s.req
          }}
        </text>

        <rect fill="var(--dc3-be-stroke)" filter="url(#ta-glow)" height="90" opacity="0.2" rx="14" width="250" x="310"
              y="135"/>
        <rect fill="var(--vp-c-bg)" height="80" rx="10" width="230" x="320" y="140"/>
        <rect fill="var(--dc3-be-fill)" height="80" rx="10" stroke="var(--dc3-be-stroke)" stroke-width="2.5" width="230"
              x="320" y="140"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" font-weight="700" text-anchor="middle" x="435"
              y="175">{{ s.ctrl }}
        </text>
        ...
        <rect fill="var(--dc3-rose-fill)" height="60" rx="8" stroke="var(--dc3-rose-stroke)" stroke-width="1.5"
              width="240" x="640" y="70"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="760" y="105">{{
            s.nf
          }}
        </text>
        ...
        <rect fill="var(--dc3-amber-fill)" height="60" rx="8" stroke="var(--dc3-amber-stroke)" stroke-width="1.5"
              width="250" x="640" y="240"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13" text-anchor="middle" x="765" y="267">{{
            s.ft
          }}
        </text>
