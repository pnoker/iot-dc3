    ...
    <div class="dc3-diagram">
      <svg :aria-label="s.aria" role="img" viewBox="0 0 1000 440">
        <defs>
          ...
          <filter id="prd-glow" height="180%" width="180%" x="-40%" y="-40%">
            <feGaussianBlur stdDeviation="6"/>
          </filter>
        </defs>

        <!-- edges (behind boxes) -->
        <line marker-end="url(#prd-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="210" x2="376" y1="222"
              y2="222"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="293" y="214">{{ s.fk }}</text>
        <line marker-end="url(#prd-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="584" x2="756" y1="200"
              y2="108"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="650" y="146">{{ s.agg }}</text>
        <line marker-end="url(#prd-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="584" x2="756" y1="222"
              y2="222"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="670" y="214">{{ s.agg }}</text>
        <line marker-end="url(#prd-ah)" stroke="var(--dc3-arrow)" stroke-width="1.5" x1="584" x2="756" y1="244"
              y2="336"/>
        <text fill="var(--dc3-arrow-label)" font-size="11" text-anchor="middle" x="650" y="300">{{ s.agg }}</text>
        <path d="M 135 254 L 135 362 Q 135 362 155 362 L 376 362" fill="none" marker-end="url(#prd-ah)"
        ...
        <rect fill="var(--dc3-ext-fill)" height="64" rx="8" stroke="var(--dc3-ext-stroke)" stroke-width="1.5"
              width="150" x="60" y="190"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13.5" text-anchor="middle" x="135" y="216">
          {{ s.device }}
        </text>
        <text fill="var(--dc3-text2)" font-size="10" text-anchor="middle" x="135" y="235">{{ s.deviceSub }}</text>

        <!-- profile (hero) -->
        <rect fill="var(--dc3-be-stroke)" filter="url(#prd-glow)" height="84" opacity="0.28" rx="12" width="204" x="380"
              y="180"/>
        <rect fill="var(--vp-c-bg)" height="84" rx="10" width="204" x="380" y="180"/>
        <rect fill="var(--dc3-be-fill)" height="84" rx="10" stroke="var(--dc3-be-stroke)" stroke-width="2.5" width="204"
              x="380" y="180"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="16" font-weight="700" text-anchor="middle" x="482"
              y="213">{{ s.profile }}
        </text>
        <text fill="var(--dc3-text2)" font-size="10" text-anchor="middle" x="482" y="233">{{ s.profileSub }}</text>
        <text fill="var(--dc3-be-text)" font-size="9" font-weight="600" text-anchor="middle" x="482" y="250">{{
            s.plus
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="62" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="184"
              x="760" y="72"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="852" y="100">{{
            s.point
          }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="62" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="184"
              x="760" y="192"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="852" y="220">
          {{ s.command }}
        </text>
        ...
        <rect fill="var(--dc3-fe-fill)" height="62" rx="8" stroke="var(--dc3-fe-stroke)" stroke-width="1.5" width="184"
              x="760" y="312"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="12.5" text-anchor="middle" x="852" y="340">{{
            s.event
          }}
        </text>
        ...
        <rect fill="var(--dc3-bus-fill)" height="64" rx="8" stroke="var(--dc3-bus-stroke)" stroke-width="1.5"
              width="204" x="380" y="330"/>
        <text class="d-name" fill="var(--dc3-box-name)" font-size="13.5" text-anchor="middle" x="482" y="358">
          {{ s.driver }}
        </text>
