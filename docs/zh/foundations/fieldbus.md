...
1. 孙昊 等. 物联网之魂：物联网协议与物联网操作系统[M]. 北京：机械工业出版社，2019. ISBN 978-7-111-62931-3.（第 1 章 1.14.2 节 基于现场总线的协议转换器 p165 — 主从模型/Modbus 功能码；1.6.1–1.6.2 节 HTTP 协议 p49、p51 — 客户端-服务器模型；1.13.2 节 发布和订阅模型 p155 — 发布-订阅模型）
