...
- [模板 Profile](../introduction/concepts/profile) 是**一类设备的能力模板**。给"温湿度传感器 ZS-100"建一个
...
- [模板 Profile](../introduction/concepts/profile) — 一类设备的能力模板，聚合全部位号
