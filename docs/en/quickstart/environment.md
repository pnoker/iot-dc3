...
> You are here: you've already [developed locally from source](./) or brought the stack up with Compose. Next, see [Deployment Modes and Image Sources](../guide/usage) to learn how the whole stack starts.
...
- [Develop Locally from Source](./) — the full path of bringing up the stack, logging in, and running your first device end to end
