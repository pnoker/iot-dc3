...
3. That is all — the `dc3` images ship every certified adapter; nothing else in the stack is broker-specific.
...
Every adapter below passes the same broker-neutral contract suite (`dc3-mq-tck`) against a live broker.
