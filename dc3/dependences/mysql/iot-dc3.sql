...
CREATE TABLE `dc3_device`  (
  ...
  CONSTRAINT `dc3_device_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `dc3_image`  (
  ...
  UNIQUE INDEX `name`(`name`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `dc3_image_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- ----------------------------
INSERT INTO `dc3_image` VALUES (-1, 'dc3-logo', '/images/logo/dc3-logo.png', -1, 'dc3平台logo，默认创建', '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
...
CREATE TABLE `dc3_label`  (
  ...
  INDEX `image_id`(`image_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `dc3_label_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `dc3_label_bind`  (
  ...
  CONSTRAINT `dc3_label_bind_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `dc3_point`  (
  ...
  CONSTRAINT `dc3_point_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `dc3_point_ibfk_2` FOREIGN KEY (`device_id`) REFERENCES `dc3_device` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `dc3_point_ibfk_3` FOREIGN KEY (`unit_id`) REFERENCES `dc3_unit` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `dc3_point_ibfk_4` FOREIGN KEY (`profile_id`) REFERENCES `dc3_point_profile` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE `dc3_rtmp`  (
  ...
  INDEX `image_id`(`image_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `dc3_rtmp_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
-- Records of dc3_rtmp
-- ----------------------------
INSERT INTO `dc3_rtmp` VALUES (-2, '在线测试视频', 'http://vfx.mtime.cn/Video/2019/03/19/mp4/190319104618910544.mp4', 'rtmp://dc3.nginx:1935/rtmp/190314223540373995_online', '{exe} -re -stream_loop -1 -i {rtsp_url} -vcodec copy -acodec copy -f flv -y {rtmp_url}', 0, 0, 0, -1, -1, '在线视频流（无限动力预告），用于测试使用', '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_rtmp` VALUES (-1, '本地测试视频', 'D:/FFmpeg/bin/190314223540373995.mp4', 'rtmp://dc3.nginx:1935/rtmp/190314223540373995_local', '{exe} -re -stream_loop -1 -i {rtsp_url} -vcodec copy -acodec copy -f flv -y {rtmp_url}', 0, 0, 0, -1, -1, '本地MP4视频文件（复仇者联盟预告），用于测试使用', '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
...
CREATE TABLE `dc3_unit`  (
  ...
  UNIQUE INDEX `name`(`name`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `dc3_unit_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `dc3_user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '单位表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dc3_unit
-- ----------------------------
INSERT INTO `dc3_unit` VALUES (-10, '度|°|%.3f', '度', '°', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-9, '升|L|%.3f', '升', 'L', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-8, '立方米|m³|%.3f', '立方米', 'm³', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-7, '平方米|m²|%.3f', '平方米', 'm²', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-6, '千克|kg|%.3f', '千克', 'kg', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-5, '克|g|%.3f', '克', 'g', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-4, '千米|km|%.3f', '千米', 'km', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-3, '米|m|%.3f', '米', 'm', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-2, '厘米|cm|%.3f', '厘米', 'cm', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
INSERT INTO `dc3_unit` VALUES (-1, '毫米|mm|%.3f', '毫米', 'mm', '%.3f', -1, NULL, '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
...
CREATE TABLE `dc3_user`  (
  ...
  INDEX `image_id`(`image_id`) USING BTREE,
  CONSTRAINT `dc3_user_ibfk_1` FOREIGN KEY (`image_id`) REFERENCES `dc3_image` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dc3_user
-- ----------------------------
INSERT INTO `dc3_user` VALUES (-1, 'pnoker', 'dc3dc3dc3', -1, 1, '平台开发者账号', '2019-10-01 00:00:00', '2019-10-01 00:00:00', 0);
