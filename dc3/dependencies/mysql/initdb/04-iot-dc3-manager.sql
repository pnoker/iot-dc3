...
--
DELIMITER $$
CREATE TRIGGER track_driver_device_revision_insert
    AFTER INSERT
    ON dc3_device
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER track_driver_device_revision_delete
    AFTER DELETE
    ON dc3_device
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER track_driver_device_revision_update
    AFTER UPDATE
    ON dc3_device
    FOR EACH ROW
BEGIN
