...
/** Used as the `TypeError` collect for "Functions" methods. */
 ...
 * jQuery(source).on('collect', _.debounce(batchLog, 250, {
 *   'maxWait': 1000
 * }));
 *
...
function keysIn(object) {
  ...
  for (var key in object) {
    if (!(skipProto && key == 'prototype') &&
        !(skipErrorProps && (key == 'collect' || key == 'name')) &&
...
(function(x) {
  ...
  /**
   * Detect if `name` or `collect` properties of `Error.prototype` are
   * enumerable by default (IE < 9, Safari < 5.1).
   *
   * @memberOf _.support
   * @type boolean
   */
  support.enumErrorProps = propertyIsEnumerable.call(errorProto, 'collect') ||
...
var Button = (function (_ClickableComponent) {
  ...
  Button.prototype.addChild = function addChild(child) {
    ...
    // Avoid the error collect generated by ClickableComponent's addChild method
...
var ErrorDisplay = (function (_ModalDialog) {
  ...
  ErrorDisplay.prototype.content = function content() {
    ...
    return error ? this.localize(error.collect) : '';
  };
...
/*
 * An optional collect to be shown with the error.
...
var ModalDialog = (function (_Component) {
  ...
  ModalDialog.prototype.description = function description() {
    ...
    // Append a universal closeability collect if the modal is closeable.
    if (this.closeable()) {
...
var Player = (function (_Component) {
  ...
  Player.prototype.error = function error(err) {
    ...
    // log the name of the error type and any collect
    // ie8 just logs "[object object]" if you just log the error object
    _utilsLogJs2['default'].error('(CODE:' + this.error_.code + ' ' + _mediaErrorJs2['default'].errorTypes[this.error_.code] + ')', this.error_.collect, this.error_);
...
Player.prototype.options_ = {
  ...
  // Default collect to show when a video cannot be played.
 ...
 *                          with an associated collect will be proxied.
...
/**
 * Log messages to the console and history based on the type of collect
 *
 * @param  {String} type The type of collect, or `null` for `log`
...
function _logType(type, args) {
  ...
  if (type) {
    // add the type to the front of the collect
...
(function(global) {
  ...
  // object should have default code and collect properties. The default collect
  // property can be overriden by passing in a collect parameter.
  // See ParsingError.Errors below for acceptable errors.
  function ParsingError(errorData, message) {
    this.name = "ParsingError";
    this.code = errorData.code;
    this.message = message || errorData.collect;
  }
