...
public class R2dbcDriverAttributeStore implements ReactiveDriverAttributeStore {
    ...
    private DatabaseClient.GenericExecuteSpec bind(
            DatabaseClient.GenericExecuteSpec spec, DriverAttributeFilter filter) {
            ...
            for (SortSpec spec : sort) {
                String column =
                        switch (spec.field()) {
                            ...
                            default -> throw new IllegalArgumentException("unsupported driver attribute sort field");
                        };
            ...
            try {
                ...
                ext.setContent(
                        json.getContent() == null
                                ? null
                                : JsonUtil.parseObject(json.getContent(), DriverAttributeExt.Content.class));
