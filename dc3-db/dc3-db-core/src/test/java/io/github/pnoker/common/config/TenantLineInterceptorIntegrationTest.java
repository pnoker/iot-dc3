...
@SpringBootTest(properties = {
        // explicit embedded datasource: this module carries no driver on its
        // main classpath, so the context cannot infer one
        "spring.datasource.url=jdbc:h2:mem:tenant-line;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE",
