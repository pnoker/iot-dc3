...
<p align="center">
  <img src="./.github/brand/png/banner.ru.png" alt="IoT DC3 — 多协议接入、云原生、AI 赋能的开源工业物联网平台，面向智能体演进">
</p>
...
<p align="center">
  <strong>
    IoT DC3 — мультипротокольная, облачно-нативная открытая платформа промышленного Интернета вещей.<br>
    С ИИ — от подключения устройств к промышленным агентам
  </strong>
</p>
